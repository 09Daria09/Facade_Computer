...
namespace Facade_Computer
{
    internal class Program
    {
        public class FacsdeComputer
        {
            ...
            public FacsdeComputer(VideoCard videoCard, RAM ram, HDD hdd, ODD odd, PSU psu, Sensor sensor)
            {
            ...
            public void Shutdown()
            {
                while (true)
                {
                    ...
                    Console.WriteLine(videoCard.ShowMessage());
        ...
        {
            RAM ram = new RAM(30, "DDR4", 32, 15);
            VideoCard videoCard = new VideoCard(70);
            HDD hDD = new HDD("1 ТБ", 500);
            ODD oDD = new ODD("DVD", "DVD-ROM");
            PSU psu = new PSU(50);
            Sensor sensor = new Sensor();


            FacsdeComputer comp = new FacsdeComputer(videoCard, ram, hDD, oDD, psu, sensor);
            comp.Start();
            Console.WriteLine("**********************************************");
            comp.Shutdown();
        }
